...
We primarily considered the Java/CoreNLP backend when constructing the schema because it is
...
##   <int>              <dttm>   <chr>    <chr>
## 1     0 2016-11-07 22:21:00   3.7.0       en
## 2     1 2016-11-07 22:21:00   3.7.0       en
## 3     2 2016-11-07 22:22:00   3.7.0       en
## 4     3 2016-11-07 22:23:00   3.7.0       en
## 5     4 2016-11-07 22:23:00   3.7.0       en
## 6     5 2016-11-07 22:24:00   3.7.0       en
## 7     6 2016-11-07 22:24:00   3.7.0       en
## 8     7 2016-11-07 22:25:00   3.7.0       en
...
- **speaker** character. Identity of the speaker, with \code{PER0} denoting the narratorial voice.
...
## 2      0     0     1    Please    please     X    UH    PER0  <NA>     0
## 3      0     0     2         ,         ,     .     ,    PER0  <NA>     6
## 4      0     0     3 everybody everybody  NOUN    NN    PER0  <NA>     8
## 5      0     0     4         ,         ,     .     ,    PER0  <NA>    17
## 6      0     0     5      have      have  VERB   VBP    PER0  <NA>    19
## 7      0     0     6         a         a   DET    DT    PER0  <NA>    24
## 8      0     0     7      seat      seat  NOUN    NN    PER0  <NA>    26
## 9      0     0     8         .         .     .     .    PER0  <NA>    30
## 10     0     1     0      ROOT      ROOT  <NA>  <NA>    <NA>  <NA>    NA
## # ... with 64,797 more rows, and 1 more variables: cid_end <int>
```
...
## 1      0     0     0          0          5      root          root    ROOT
## 2      0     0     5          0          1 discourse     discourse    have
## 3      0     0     5          0          2     punct         punct    have
## 4      0     0     5          0          3     nsubj         nsubj    have
## 5      0     0     5          0          4     punct         punct    have
## 6      0     0     7          0          6       det           det    seat
## 7      0     0     5          0          7      dobj          dobj    have
## 8      0     0     5          0          8     punct         punct    have
## 9      0     1     0          1          2      root          root    ROOT
## 10     0     1     2          1          1  compound      compound Speaker
## # ... with 65,271 more rows, and 3 more variables: lemma <chr>,
## #   word_target <chr>, lemma_target <chr>
```
...
The sentiment tagger provided by the CoreNLP pipeline predicts whether a sentence is very negative (0),
negative (1), neutral (2), positive (3), or very positive (4).
The sentiment output is placed in a separate table because it returns information
exclusively at the sentence level, unlike any of the other parsers. The schema
is given by:
...
## 1      0     0          2 0.058601 0.363095 0.439430 0.117105 0.021769
## 2      0     1          1 0.132826 0.697524 0.144485 0.017455 0.007710
## 3      0     2          3 0.083750 0.226689 0.129352 0.422234 0.137976
## 4      0     3          3 0.079751 0.207277 0.240439 0.358697 0.113835
## 5      0     4          3 0.066142 0.162890 0.131020 0.477982 0.161966
## 6      0     5          1 0.112066 0.607693 0.206194 0.057028 0.017018
## 7      0     6          1 0.097406 0.639818 0.199368 0.049293 0.014116
## 8      0     7          1 0.292397 0.392003 0.074113 0.110128 0.131359
## 9      0     8          1 0.234672 0.518319 0.146478 0.052902 0.047629
## 10     0     9          1 0.096802 0.579911 0.272984 0.039296 0.011008
## # ... with 2,978 more rows
```
The underlying model is a neural network. The most likely categorization is
included along with the predicted probabilities for all 5 classes.

## Information extraction

The final table in the data model contains the information of the relationship triples generated
(by default) by the OpenIE parser. These triples contain a subject,
object, and relation, all of which consist of a set of tokens in the raw text.
There are a relatively large number of fields
given the need to index three separate phrases that may be scattered across multiple sentences.
This is also the only table for which there is no natural composite key (though all of the ids
together are guaranteed to be unique). The schema is given by:
...
- **tid_subject\_end** integer. Token id at the end of the triple's subject.
- **tid_object** integer. Token id at the start of the triple's object.
- **tid_object\_end** integer. Token id at the end of the triple's object.
- **tid_relation** integer. Token id at the start of the triple's relation.
- **tid_relation\_end** integer. Token id at the end of the triple's relation.
...
```
As with the coreference and entity tables, the complete subject, object, and relation phrases
are included given the difficulty of extracting them from the data.
